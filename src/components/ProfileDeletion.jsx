...
function ProfileDeletion() {
    ...
    return (
        <div>
            <button onClick={handleDeleteClick} className="delete-button">Delete Profile</button>

            {showConfirmation && (
                <div className="confirmation-dialog" ref={confirmationRef}>
                    <p>Are you sure you want to delete your profile? This action cannot be undone.</p>
                    <button onClick={handleConfirmDelete} className="delete-button">Yes, delete my profile</button>
